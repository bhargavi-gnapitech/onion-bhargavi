...
Given(
	'User is in the Network manager applications',
	{ timeout: 600000 },
	async function () {
...
When(
	'Click on Add object, select pole and place it in existing design',
	{ timeout: 60000 },
	async function () {
	 await global.page.waitForLoadState('networkidle', { timeout: 6000 });
...
Then(
	'Input all the details and click on create',
	{ timeout: 60000 },
	async function () {
...
Then('New pole should be created', { timeout: 60000 }, async function () {
	await global.page.waitForLoadState('networkidle', { timeout: 6000 });
