  ...
  Given('the {string} user has authenticated credentials',{ timeout: 60000 }, async function (string) {
  ...
  When('the user selects the {string} option',{ timeout: 60000 }, async function (string) {
  ...
  When('the user selects the {string} mode',{ timeout: 60000 }, async function (string) {
  ...
  When('the user provides the ticket ID in the search bar',{ timeout: 60000 }, async function () {
    await regression.searchAndExpandTicket('ATT-5403');
  });



  When('selects the ticket to open',{ timeout: 60000 }, async function () {
  ...
  When('Select the {string} tab',{ timeout: 6000 }, async function (string) {
    await regression.clickPaymentTab();
  });



  Then('Payment interface is opened',{ timeout: 6000 }, async function () {
