    ...
    let login;
    let regression;
  Given('the user navigates to the Design page',{ timeout: 600000 }, async function () {
  ...
  When('the user selects the Export option',{ timeout: 60000 }, async function () {
  ...
  Then('the application opens the Export Design dialog',{ timeout: 60000 }, async function () {
    await regression.clickExportButton();
  });



  Then('then the user clicks the CDIF button',{ timeout: 6000 }, async function () {
    await regression.clickExportCDIF();
  });



  Then('the export file is downloaded to the Downloads folder',{ timeout: 60000 }, async function () {
